                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('furnitor.update') }}" id="myForm" >
                                @csrf

                                <input type="hidden" name="id" value="{{ $furnitor->id }}">

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Name </label>
                                    <div class="form-group col-sm-10">
                                        <input name="name" class="form-control" value="{{ $furnitor->name }}" type="text"    >
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="phone" value="{{ $furnitor->phone }}" class="form-control" type="text"    >
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="email" value="{{ $furnitor->email }}" class="form-control" type="email"  >
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="adresa" value="{{ $furnitor->adresa }}" class="form-control" type="text"  >
                                    </div>
                                </div>
                                <!-- end row -->
